...
const GetPost =  (props) => {
  ...
  return (
    <>
    <section className="border border-spacing-5 rounded-md">
    <div className="w-full border border-spacing-7 min-h-10 p-6" key={post._id}>
        <div className="w-ful">
            <h1 className="font-bold text-clip text-gray-900 line-clamp-5">
            {post.content}
            </h1>
        </div>
    </div>
    <div className="flex justify-end flex-row gap-9 items-center">
          <button class="btn">
